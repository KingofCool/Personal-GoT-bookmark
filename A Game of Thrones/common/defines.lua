...
NDiplomacy = {
	...
	DOWRY_MULTIPLIER = 0,						-- The Dowry cost for a Patrician is prestige gain from marriage * this
...
NCouncil = {
	...
	REGENCY_VOTING = "laws declare_war_interaction revoke_title_interaction imprison_character_interaction grant_landed_title_interaction exile_imprisoned_interaction execute_imprisoned_interaction release_from_prison_interaction ransom_character_interaction retract_vassal_interaction transfer_vassal_interaction ask_for_vassalization_interaction release_vassal_interaction assign_voter_title_interaction revoke_voter_title_interaction absorb_clan_interaction grant_lp revoke_royal_privilege grant_royal_privilege seek_raiding_redress declare_feud insult_character break_non_aggression_pact NW_grant_command vassal_castrate_decision_AGOT vassal_blinding_decision_AGOT banish_prisoner take_prisoner_as_wife torture_prisoner prisoner_to_oubilette prisoner_torture prisoner_mutilate prisoner_humiliation sell_prisoner enslave_prisoner recruit_prisoner ransom_all make_noble nominate_prince revoke_freehold execute_decision",					-- In regencies the council votes on these issues
...
NCharacter = {
	...
	LUNATIC_DIVINE_BLOOD_TRAIT_CHANCE_FACTOR = 0.5,	-- Inbreeding: Multiplier to the base chance
	...
	NON_AGGRESSION_PACT_BLOCKS_FACTIONS = 0,		-- If set to 1 then factions will be blocked for vassals that have a non-aggression pact with their liege.
	...
	BASE_NR_OF_CHILDREN_PER_COUPLE = 12,
	EXTRA_NR_OF_CHILDREN_FOR_PLAYERS = 40,
...
-- Title Destruction Prestige Cost
	...
	KING_DESTRUCTION_PRESTIGE_COST = 40000, -- We don't want the 7 kingdoms to turn into the 6 kingdoms
...
NReligion = {
	AUTHORITY_FROM_CROWN_LOYALIST = 0.00,
	AUTHORITY_FROM_CHURCH_LOYALIST = 0.00,
	CREATE_ANTIPOPE_PRESTIGE_COST = 100000,
	POPE_DIPLO_TO_AUTHORITY_DIV = 100000,
...
NMilitary = {
	...
	BATTLE_WARSCORE_HOSTS_MULTIPLIER = 1.25,			-- Multiplier applied to the warscore value of major battle (replaces BATTLE_WORTH_SCORE_MULTIPLIER in that case
...
NTechnology = {
	...
	FOCUS_BONUS = 0.0, 							-- bonus for the tech in each group set as the focus
...
NAI =
{
	...
	REVOLT_DISTANCE_FACTOR = 0.9,							-- Multiplier for how much distance from capital affects independence minded revolters
	REVOLT_OTHER_INDEP_RISK = 8,							-- Each ongoing other independence revolt increases revolt risk by this amount for all independence-minded revolters
	REVOLT_OTHER_INDEP_RISK_CAP = 45,						-- Cap to the total risk from the above
